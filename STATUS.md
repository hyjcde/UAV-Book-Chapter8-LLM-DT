...
**Hallucination panel (2026-07-23):** added `fig:ch8-hallucination` (`hallucination_rate.pdf`) beside packaging ablation in §8.5; book labels Passport pack / Chunk-only / … (not IAP-RAG Ours). Skipped score/forest/paradigm leaderboard panels and field-census audits.
