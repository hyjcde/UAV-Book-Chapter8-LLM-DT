...
**Hallucination panel (2026-07-23):** added `fig:ch8-hallucination` (`hallucination_rate.pdf`) beside packaging ablation in §8.5; book labels Passport pack / Chunk-only / … (not IAP-RAG Ours).
**Full stats suite (2026-07-23):** advisor-approved complete panels in place — ksweep (§8.3); ablation + external + hallucination (§8.5); paradigm + score_by_type + forest + field_audit + field_stages (§8.6); book labels; stripped monograph/Springer meta captions.
