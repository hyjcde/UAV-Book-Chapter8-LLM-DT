...
| 项 | 状态（2026-07-21） |
|----|-------------------|
| 8.1 gap bridge（导航≠诊断等） | ✅ 已写入 EN/CN |
| 摘要 audience 句 | ✅ 已写入 |
| 去掉 `\textbf{小标题}` 碎片 | ✅ EN/CN `bold=0`；改为连贯起句 |
| 节末 Summary bridge（8.2→8.6） | ✅ 四段 In summary / 概括 |
| 教学目标表（专著路线图） | ✅ `tab:ch8-outcomes` |
| 图题自足检查 | 🔲 人工扫 PDF |
| 勿把 8.2 改成独立 survey 章 | ✅ 保持决策层专门化 |

仍可做：人工通读图题；把 8.6 超长教学段再压成更少重复的连续叙述（可选）。
